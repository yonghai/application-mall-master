    ...
    <body>
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">类别管理</a></li>
                                    <li class="breadcrumb-item active">新增类别</li>
                                </ol>
                            </div>
                            ...
                            <form id="formSubmitAction" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cname" parsley-trigger="change" required
                                           placeholder="输入分类名称" class="form-control" id="cname">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="2" name="orderBy" parsley-trigger="change" required
                                           placeholder="输入0~99数字" value="0" class="form-control" id="orderBy"/>
                                </div>
		...
		<script type="text/javascript">
			$('#formSubmitAction').submit(function() {
				...
				$.ajax({
					url: '<c:url value='/product/category/save'/>',
					type : 'post',
					data: {"productCategoryCustom.name":cname,"productCategoryCustom.orderBy":orderBy,"token":token},
	          		dataType: "json",
	          		beforeSend:function(){  
	                    _index = layer.load(2);
	                },
