(function($) {
    $.fn.upload = function(look_call_back,A){
        var  _this = $(this),
        ...
        look = '<svg xmlns="http://www.w3.org/2000/svg" align="center" class="tag" style="top:15%;position:absolute;height:30px;margin-top:-15px;left:43%;color:#fff;z-index:10;transition:all .3s;cursor:pointer;" version="1" viewBox="0 0 1024 1024"><path fill="#fff" d="M451 835a386 386 0 1 1 0-771 386 386 0 0 1 0 771zm0-675a291 291 0 1 0 0 581 291 291 0 0 0 0-581zm450 798c-15 0-30-5-42-17L658 740a58 58 0 0 1 83-82l201 201a58 58 0 0 1-41 99"/></svg>',
