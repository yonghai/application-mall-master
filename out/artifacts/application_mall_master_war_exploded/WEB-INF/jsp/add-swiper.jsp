        ...
        <div class="wrapper">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">新增轮播图</li>
                                </ol>
                            </div>
                            <h4 class="page-title">新增轮播图</h4>
                        </div>
                    </div>
                </div>
				...
				<div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="header-title m-t-0">新增轮播图</h4>
							...
							<form id="formSubmitAction" role="form">
								...
								<div class="form-group">
									<button type="button" class="layui-btn header-title m-t-0" id="test1">上传图片</button>
									<div class="layui-upload-list">
									  	<a href="<c:url value='/resource/assets/images/img_xc_bg.jpg'/>" data-lightbox="gallery" data-title="" id="preview-img">
		...
		<script type="text/javascript">
			...
			$('#formSubmitAction').submit(function() {
				if(tempFile.length<1){
					...
					$.ajax({
						url: '<c:url value='/swiper/save'/>',
						type : 'post',
						data: {"swiperCustom.url":tempFile,"swiperCustom.content":content,"token":token},
	           				dataType: "json",
	           				beforeSend:function(){  
		                    _index = layer.load(2);
		                },
