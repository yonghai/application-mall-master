				...
				<div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>公告列表</b></h4>
                            <p class="text-muted font-14 m-b-30">
                            	在这里可以实现对公告的管理,包括对公告的删、改、查功能.
                            </p>
			...
			$(document).ready(function() {
                ...
                table = $('#datatable-buttons').DataTable({
                    ...
                    ajax: function (data, callback, settings) {
		                ...
		                $.ajax({
		                    type: "POST",
		                    url: "<c:url value="/notice/listPage"/>",
		                    cache: false,  //禁用缓存
		                    data: {"noticeCustom.limit":param.limit,"noticeCustom.start":param.start,"noticeCustom.page":param.page}, //传入组装的参数
		                    dataType: "json",
		            ...
		            columns: [
						...
						{ 
		                	...
		                	"render": function ( data, type, full, meta ) {  
			                    ...
			                    _html = _html + '<a class="ml-2" onClick="edit(\'编辑\',\'<c:url value="/notice/select"/>\',\''+data+'\')" href="javascript:;" title="编辑"><i class="dripicons-pencil"></i></a>';
