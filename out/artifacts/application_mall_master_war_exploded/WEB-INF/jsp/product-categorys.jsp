    ...
    <body>
				...
				<div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>产品类别列表</b></h4>
                            <p class="text-muted font-14 m-b-30">
                            	在这里可以实现对产品类别的管理,包括对产品类别的删、改、查功能.
                            </p>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered table-centered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th style="vertical-align: middle;">分类名称</th>
                                    <th style="vertical-align: middle;">顺序</th>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
                ...
                table = $('#datatable-buttons').DataTable({
                    ...
                    ajax: function (data, callback, settings) {
		                ...
		                $.ajax({
		                    type: "POST",
		                    url: "<c:url value="/product/category/listPage"/>",
		                    cache: false,  //禁用缓存
		                    data: {"productCategoryCustom.limit":param.limit,"productCategoryCustom.start":param.start,"productCategoryCustom.page":param.page}, //传入组装的参数
		                    dataType: "json",
		            ...
		            columns: [
						...
						{ 
		                	...
		                	"render": function ( data, type, full, meta ) {  
			                    var _html;
			                    _html = '<a class="ml-2" onClick="edit(\'编辑\',\'<c:url value="/product/category/select"/>\',\''+data+'\')" href="javascript:;" title="编辑"><i class="dripicons-pencil"></i></a>';
			...
			function edit(title,url,id){
				url = url+'?productCategoryCustom.id='+id;
				console.log(url);
			...
			function del(obj,id){
				layer.confirm('确认要删除吗？',function(index){
					$.ajax({
						url: '<c:url value='/product/category/delete'/>',
						type : 'post',
						data: {"productCategoryCustom.id":id},
			         	dataType: "json",
