                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">优惠券列表</li>
                                </ol>
                            </div>
                            <h4 class="page-title">优惠券列表</h4>
                        </div>
                    </div>
                </div>
				...
				<div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>优惠券列表</b></h4>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered table-centered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th style="vertical-align: middle;">总量</th>
                                    <th style="vertical-align: middle;">剩余</th>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
                ...
                table = $('#datatable-buttons').DataTable({
                    ...
                    ajax: function (data, callback, settings) {
		                ...
		                $.ajax({
		                    type: "POST",
		                    url: "<c:url value="/coupons/get"/>",
		                    cache: false,  //禁用缓存
		                    data: {"couponsCustom.limit":param.limit,"couponsCustom.start":param.start,"couponsCustom.page":param.page}, //传入组装的参数
		                    dataType: "json",
		            ...
		            columns: [
						...
						{ 
		                	...
		                	"render": function ( data, type, full, meta ) {  
			                    var _html='';
			                    _html = _html + '<a class="ml-2" onClick="edit(\'查看\',\'<c:url value="/coupons/fetchListPage"/>\',\''+data+'\')" href="javascript:;" title="查看"><i class="dripicons-pencil"></i></a>';
			...
			function del(obj,flag){
				layer.confirm('确认要删除吗？',function(index){
					$.ajax({
						url: '<c:url value='/coupons/deleteByFlag'/>',
						type : 'post',
						data: {"couponsCustom.flag":flag},
			         	dataType: "json",
