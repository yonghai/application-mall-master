                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered table-centered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th style="vertical-align: middle;">评分</th>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
                ...
                table = $('#datatable-buttons').DataTable({
                    ...
                    ajax: function (data, callback, settings) {
		                ...
		                $.ajax({
		                    type: "POST",
		                    url: "<c:url value="/shop/reputations"/>",
		                    cache: false,  //禁用缓存
		                    data: {"reputationCustom.limit":param.limit,"reputationCustom.start":param.start,"reputationCustom.page":param.page}, //传入组装的参数
		                    dataType: "json",
		            ...
		            columns: [
						...
						{ 
		                	...
		                	"className": "td-manage",  
		                	"render": function ( data, type, full, meta ) {  
			                    var _html = '<a class="ml-2" onClick="del(this,\''+data+'\')" href="javascript:;" title="删除"><i class="dripicons-trash"></i></a>';
			                    return _html;  
			                } 
						}
		            ]
			...
			function del(obj,id){
				layer.confirm('确认要删除吗？',function(index){
					$.ajax({
						url: '<c:url value='/reputation/delete'/>',
						type : 'post',
						data: {"reputationCustom.id":id},
			         	dataType: "json",
